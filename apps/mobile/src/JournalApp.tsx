...
export default function JournalApp() {
  ...
  if (saveStatus === 'opening') {
    return (
      <View style={[styles.loadingScreen, { paddingTop: insets.top, paddingBottom: Math.max(insets.bottom, 10) }]}>
        <Image source={require('../assets/splash-icon.png')} style={styles.loadingTile} accessibilityLabel="Munimuni" />
        <Text style={styles.loadingWordmark}>munimuni</Text>
        <Text style={styles.loadingMessage}>Opening your journal…</Text>
      </View>
    );
  }
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      <View style={styles.topbar}>
        <Pressable style={styles.brand} onPress={() => selectDate(today)} accessibilityLabel="Go to today"><Image source={require('../assets/icon.png')} style={styles.brandIcon} accessibilityLabel="Munimuni" /><Text style={styles.brandName}>munimuni</Text></Pressable>
